...
export async function POST(request: Request) {
  ...
  const prompt = [
    ...
    "- A proposta é uma MENSAGEM PRONTA pra enviar ao cliente na plataforma (Workana/Upwork/e-mail). Siga ESTA estrutura, nesta ordem — curta e escaneável, SEM emojis e SEM parágrafos gigantes:",
    "  1) GANCHO (1a linha): cite um detalhe ESPECÍFICO do escopo do cliente (algo concreto que ele descreveu). É o que aparece na prévia da plataforma e faz ele abrir. Nada genérico tipo 'Olá, tudo bem'.",
    "  2) PROVA SOCIAL (logo na 2a linha): nota máxima 5 estrelas na Workana e clientes que voltam a contratar/recomendam o trabalho. É o maior diferencial — SEMPRE inclua, logo no início.",
    ...
    "  5) PERGUNTA NO FINAL: termine com UMA pergunta que convide resposta — sobre conteúdo, número de páginas/produtos ou prazo. Conversa iniciada fecha muito mais.",
    ...
    "- No TOTAL a proposta é CURTA: gancho, prova social, resultado + valor/prazo, pergunta e o link. Tom consultivo e confiante, sem exagero. Pode incluir os serviços novos no valor fechado.",
    "",
    "SERVIÇOS (JSON):",
